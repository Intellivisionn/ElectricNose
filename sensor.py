...
from GroveGasSensor import GroveGasSensor
...
def read_sensor_data():
    ...
    data = {
        ...
        "Grove": {
            "NO2": grove.measure_no2(),
            "Ethanol": grove.measure_ethanol(),
            "VOC": grove.measure_voc(),
            "CO": grove.measure_co(),
            "0x04": grove.measure_4(),
            "0x08": grove.measure_8(),
